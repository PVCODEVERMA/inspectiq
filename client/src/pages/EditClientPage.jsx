...
const EditClientPage = () => {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-background/50 flex flex-col items-center justify-center">
                <Loader2 className="w-10 h-10 animate-spin text-primary mb-4" />
                <p className="text-muted-foreground font-medium">Loading client details...</p>
            </div>
        );
    }
                ...
                <Card className="rounded-[2.5rem] border-none shadow-premium bg-white overflow-hidden uppercase">
                    <CardHeader className="bg-primary/5 pb-8 pt-8 px-8">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <CardTitle className="text-2xl font-black">Update Client</CardTitle>
                                <CardDescription>Modify the details for this company profile</CardDescription>
                            </div>
                        </div>
                    </CardHeader>
