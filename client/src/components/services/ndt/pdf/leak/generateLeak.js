...
export const generateLeak = (doc, data, currentY, contentWidth, primaryFont, checkPageBreak, drawTemplate) =>
    generateGenericNDT(doc, data, currentY, contentWidth, primaryFont, "LEAK TESTING", checkPageBreak, drawTemplate);
