...
export const generateRT = (doc, data, currentY, contentWidth, primaryFont, checkPageBreak, drawTemplate) =>
    generateGenericNDT(doc, data, currentY, contentWidth, primaryFont, "RADIOGRAPHIC TESTING", checkPageBreak, drawTemplate);
