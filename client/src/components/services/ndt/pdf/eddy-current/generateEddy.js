...
export const generateEddy = (doc, data, currentY, contentWidth, primaryFont) =>
    generateGenericNDT(doc, data, currentY, contentWidth, primaryFont, "EDDY CURRENT TESTING");
