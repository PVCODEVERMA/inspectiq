...
export const generateVT = (doc, data, currentY, contentWidth, primaryFont, checkPageBreak, drawTemplate) =>
    generateGenericNDT(doc, data, currentY, contentWidth, primaryFont, "VISUAL TESTING", checkPageBreak, drawTemplate);
